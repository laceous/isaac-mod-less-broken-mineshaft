...
if REPENTOGON then
  ...
  mod.roomData = {
    ...
    -- fiend folio reheated (175xx/176xx/19xxx)
    -- fiend folio reloaded (177xx/178xx/20xxx)
    [17649] = {
    ...
    [17651] = {
      ...
      [StbRailVariant.HORIZONTAL]    = { 98, 99, 54, 53 },
  ...
  for k, v in pairs({
                     [10010] = { 10012, 10015, 10016, 10017, 10124, 10126, 10128, 10130, 10132, 10140, 10142, 10144, 10146, 17647, 17648, 17650, 19691, 17504, 17662, 19696, 8276, 8277, 8292, 8298, 17842, 17843, 17845, 20319, 17759, 17857, 20324 },
                     [10072] = { 10074, 10076, 10078, 10080, 10084, 10086, 10088, 10090, 10092, 10094, 10096, 10098, 17656, 17658, 8290, 8302, 17851, 17853 },
                     [10100] = { 10102, 10104, 10106, 10108, 10110, 10112, 10114, 10116, 10118, 10120, 10122, 17508, 17670, 17672, 17763, 17869, 17871 },
        ...
        for _, gridIdx in ipairs(tbl) do
          ...
          for _, v in ipairs(Isaac.GetRoomEntities()) do
            if v.Type == EntityType.ENTITY_BOMB_GRIMACE or
               v.Type == EntityType.ENTITY_MOVABLE_TNT or
