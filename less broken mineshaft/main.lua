...
if REPENTOGON then
  ...
  mod.roomData = {
    ...
    -- todo: rooms galore, rooms galore fiendish edition
  }
  for k, v in pairs({
                     [10010] = { 10012, 10015, 10016, 10017, 10124, 10126, 10128, 10130, 10132, 10140, 10142, 10144, 10146, 17647, 17648, 17650, 19691, 17504, 17662, 19696 },
                     [10072] = { 10074, 10076, 10078, 10080, 10084, 10086, 10088, 10090, 10092, 10094, 10096, 10098, 17656, 17658 },
